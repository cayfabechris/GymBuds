...
if(!empty($email)){
    ...
    if($sql->num_rows == 0 && strlen($email) > 0){
        ...
        <h1>GymBuds</h1>
        <br>
        Use your token " . $fpToken . " on the <a href = http://localhost/gymBuds/GymBuds/acctverify.php>new password</a> page to create a new password for your GymBuds account.
        </body>
        </head>
        </html>";
